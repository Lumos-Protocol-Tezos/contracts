...
(* View the settings of a specific Investment Token *)
[@view]
let get_token_settings (p,s : get_token_settings_param * Storage.t) : ProtocolSettings.t option = 
  ...
  Big_map.find_opt (p.token_id) token_details_map

(* Set the settings of a specific Investment Token *)
